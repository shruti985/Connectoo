...
const Signup = () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          ...
          "Check your email and enter the OTP to complete signup.",
      });
      setOtpStep(true);
    } catch (error: any) {
      toast({
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const response = await axios.post(`${API_BASE}/signup/verify`, {
        email: formData.email,
        otp: otp.trim(),
      });
      ...
      toast({
        ...
        description:
          error.response?.data?.message || "Could not verify OTP. Try again.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
