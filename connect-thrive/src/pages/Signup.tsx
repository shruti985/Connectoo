...
const API_ROOT = "https://connectoo-hhu6.onrender.com/api";
        ...
        <div className="glass-card p-8">
          <div className="text-center mb-8">
            <Link to="/" className="inline-block mb-4">
              <motion.span className="text-3xl font-display font-bold gradient-text" whileHover={{ scale: 1.05 }}>
                Connecto
              </motion.span>
            </Link>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="hometown" name="hometown" type="text" placeholder="Your hometown"
                  value={formData.hometown} onChange={handleChange} className="pl-10" required />
              </div>
            </div>
            ...
            <Button type="submit" className="w-full btn-glow" disabled={isLoading}>
              {isLoading ? (
                <motion.div className="w-5 h-5 border-2 border-primary-foreground border-t-transparent rounded-full"
